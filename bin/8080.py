...
def print_help():
    print('\nThis ' + Fore.BLUE + 'Intel' + Fore.WHITE + ' 8080 assembler was made for ' +
          Fore.BLUE + 'Project ' + Fore.YELLOW + 'Week' + Fore.WHITE + ' at my school.')
    print('It is written in ' + Fore.BLUE +
          'Pyt' + Fore.YELLOW + 'hon' + Fore.WHITE)
                    ...
                    try:
                        if(int(sc_line.split(' ')[2]) >= (2**8)):
                            print(Fore.RED + 'Variable too large: ' +
                                  sc_line + ' : Line ' + str(i + 1))
                            raise SyntaxError
                        var_dict[sc_line.split(' ')[0]] = UnHex(
                            sc_line.split(' ')[2])  # It is, save it to a dictionary
                        print('Updating variables')
                        continue

                    except TypeError:
                        print(Fore.RED + 'Digit count not divisible by 2: ' +
                              sc_line + ' : Line ' + str(i + 1))
                        raise SyntaxError
                    ...
                    for k in VAR_INSTRUCTION_TABLE.keys():
                        if sc_line.startswith(k):
                            ...
                            try:
                                ...
                                variable = sc_line.split(',')[1].strip(
                                ) if "," in sc_line else sc_line.split()[1].strip()
